if (function() {
        ...
        function b(b, c) {
            ...
            a(window).on("resize" + e.ns, function() {
                ...
                e._f2()
            }), e._f2()), e.hasTouch && e.st.sliderTouch || !e.hasTouch && e.st.sliderDrag ? e._p1.on(e._j1, function(a) {
                e._g2(a)
            }) : e.dragSuccess = !1;
        ...
        a.rsModules || (a.rsModules = {
            ...
            _b2: function() {
                ...
                c._b.on("keydown" + c.ns, function(e) {
                    c._l2 || (b = e.keyCode, 37 !== b && 39 !== b || a || (e.preventDefault(), d(b), a = setInterval(function() {
                        d(b)
                    }, 700)))
                        ...
                        if (b.images) {
                            if (!b.isLoading) {
                                ...
                                if (b.content.hasClass("rsImg") ? (c = b.content, e = !0) : c = b.content.find(".rsImg:not(img)"), c && !c.is("img") && c.each(function() {
                                    ...
                                    }), c = e ? b.content : b.content.find("img.rsImg"), j(), c.eq(0).addClass("rsMainSlideImage"), b.iW && b.iH && (b.isLoaded || d._q2(b), h()), b.isLoading = !0, b.isBig) a("<img />").on("load.rs error.rs", function(b) {
                                    a(this).off("load.rs error.rs"), f([this], !0)
                                }).attr("src", b.image);
                                else {
                                    b.loaded = [], b.numStartedLoad = 0, c = function(c) {
            ...
            _f4: function(a) {
                ...
                b.currSlide = b.slides[b.currSlideId], b._r1 = b.slidesJQ[b.currSlideId], b.currSlideId >= b.numSlides ? b.goTo(b.numSlides - 1) : 0 > b.currSlideId && b.goTo(0), b._t(), b._l && b._p1.css(b._g + b._u1, "0ms"), b._h4 && clearTimeout(b._h4), b._h4 = setTimeout(function() {
            ...
            _q2: function(a, b) {
                if (!a.isRendered) {
                    var c, d, e = a.content,
                        ...
                        h = this.st.imageScaleMode;
                    if (a.videoURL && (f = "rsVideoContainer", "fill" !== h ? c = !0 : (d = e, d.hasClass(f) || (d = d.find("." + f)), d.css({
                            width: "100%",
                            height: "100%"
                        }), f = "rsMainSlideImage")), e.hasClass(f) || (e = e.find("." + f)), e) {
                        var i = a.iW,
                            j = a.iH;
                        if (a.isRendered = !0, "none" !== h || g) {
                            f = "fill" !== h ? this._d4 : 0, d = this._b4 - 2 * f;
                            var k, l, m = this._c4 - 2 * f,
                                n = {};
                            "fit-if-smaller" === h && (i > d || j > m) && (h = "fit"), ("fill" === h || "fit" === h) && (k = d / i, l = m / j, k = "fill" == h ? k > l ? k : l : "fit" == h ? l > k ? k : l : 1, i = Math.ceil(i * k, 10), j = Math.ceil(j * k, 10)), "none" !== h && (n.width = i, n.height = j, c && e.find(".rsImg").css({
                                width: "100%",
                                height: "100%"
                            })), g && (n.marginLeft = Math.floor((d - i) / 2) + f, n.marginTop = Math.floor((m - j) / 2) + f), e.css(n)
                        }
                    }
                }
            }
        ...
        a.extend(a.rsProto, {
            _i5: function() {
                ...
                "bullets" === b.st.controlNavigation && (b.ev.one("rsAfterPropsSetup", function() {
                    ...
                    b._k5 = c = a(c + "</div>"), b._l5 = c.appendTo(b.slider).children(), b._k5.on("click.rs", ".rsNavItem", function(c) {
        ...
        a.extend(a.rsProto, {
            _h6: function() {
                ...
                "thumbnails" === b.st.controlNavigation && (b._i6 = {
                    ...
                    a = "<div" + b._n6 + ' class="rsNavItem rsThumb">' + b._o6 + c.thumbnail + "</div>", b._e && b._s3.css(b._g + "transition-duration", "0ms"), d >= b.numSlides ? b._s3.append(a) : b._l5.eq(d).before(a), b._l5 = b._s3.children(), b.updateThumbsSize(!0)
                }), b.ev.on("rsOnRemoveSlide", function(a, c) {
                    var d = b._l5.eq(c);
                    d && (b._e && b._s3.css(b._g + "transition-duration", "0ms"), d.remove(), b._l5 = b._s3.children(), b.updateThumbsSize(!0))
                }))
            },
            _k6: function() {
                var b, c, d = this,
                ...
                g = a(g + "</div></div>"), b = {}, f.paddingTop && (b[d._e3 ? "paddingTop" : "paddingLeft"] = f.paddingTop), f.paddingBottom && (b[d._e3 ? "paddingBottom" : "paddingRight"] = f.paddingBottom), g.css(b), d._s3 = a(g).find("." + e + "Container"), d._q6 && (e += "Arrow", f.arrowLeft ? d._r6 = f.arrowLeft : (d._r6 = a('<div class="' + e + " " + e + 'Left"><div class="' + e + 'Icn"></div></div>'),
                    g.append(d._r6)), f.arrowRight ? d._s6 = f.arrowRight : (d._s6 = a('<div class="' + e + " " + e + 'Right"><div class="' + e + 'Icn"></div></div>'), g.append(d._s6)), d._r6.click(function() {
                    var a = (Math.floor(d._i3 / d._t6) + d._u6) * d._t6 + d.st.thumbs.firstMargin;
                ...
                }))), d._k5 = g, d._l5 = d._s3.children(), d.msEnabled && d.st.thumbs.navigation && d._s3.css("-ms-touch-action", d._e3 ? "pan-y" : "pan-x"), d.slider.append(g), d._w3 = !0, d._v6 = h, f.navigation && d._e && d._s3.css(d._g + "transition-property", d._g + "transform"), d._k5.on("click.rs", ".rsNavItem", function(b) {
            ...
            updateThumbsSize: function(a, b) {
                ...
                c._t6 = (c._e3 ? d.outerWidth() : d.outerHeight()) + c._v6, c._y3 = f * c._t6 - c._v6, e[c._e3 ? "width" : "height"] = c._y3 + c._v6, c._z3 = c._e3 ? c._k5.width() : void 0 !== b ? b : c._k5.height(), c._w3 && (c.isFullscreen || c.st.thumbs.fitInViewport) && (c._e3 ? c._c4 = c._w6 - c._k5.outerHeight() : c._b4 = c._w6 - c._k5.outerWidth()), c._z3 && (c._o3 = -(c._y3 - c._z3) - c.st.thumbs.firstMargin, c._n3 = c.st.thumbs.firstMargin, c._u6 = Math.floor(c._z3 / c._t6), c._y3 < c._z3 ? (c._q3(c.st.thumbs.autoCenter ? (c._z3 - c._y3) / 2 : c._n3), c.st.thumbs.arrows && c._r6 && (c._r6.addClass("rsThumbsArrowDisabled"), c._s6.addClass("rsThumbsArrowDisabled")), c._l6 = !1, c._m5 = !1, c._k5.off(c._j1)) : c.st.thumbs.navigation && !c._l6 && (c._l6 = !0, !c.hasTouch && c.st.thumbs.drag || c.hasTouch && c.st.thumbs.touch) && (c._m5 = !0, c._k5.on(c._j1, function(a) {
                    c._g2(a, !0)
                })), c._s3.css(e), a && b && c._m6(c.currSlideId, !0))
            },
        ...
        a.extend(a.rsProto, {
            ...
            _s5: function() {
                ...
                if (b._t5 = !b.st.keyboardNavEnabled && b.st.fullscreen.keyboardNav, b.st.fullscreen.nativeFS) {
                    ...
                    if ("undefined" != typeof document.cancelFullScreen) c.supportsFullScreen = !0;
                    else
                        for (var e = 0, f = d.length; f > e; e++)
                            if (c.prefix = d[e], "undefined" != typeof document[c.prefix + "CancelFullScreen"]) {
            ...
            enterFullscreen: function(b) {
                var c = this;
                if (c._u5) {
                    if (!b) return c._b.on(c._u5.fullScreenEventName, function(a) {
            ...
            _c6: function(b, c) {
                var d = b.isLoaded || b.isLoading ? '<img class="rsImg rsMainSlideImage" src="' + b.image + '"/>' : '<a class="rsImg rsMainSlideImage" href="' + b.image + '"></a>';
                b.content.hasClass("rsImg") ? b.content = a(d) : b.content.find(".rsImg").eq(0).replaceWith(d), b.isLoaded || b.isLoading || !b.holder || b.holder.html(b.content)
            }
        ...
        a.extend(a.rsProto, {
            ...
            _f7: function(a, b) {
                var c = [],
                    d = this.st.video;
                if (d.autoHideArrows && (this._c2 && (c.push(this._c2, this._d2), this._e2 = !a), this._v5 && c.push(this._v5)), d.autoHideControlNav && this._k5 && c.push(this._k5), d.autoHideBlocks && this._d7.animBlocks && c.push(this._d7.animBlocks), d.autoHideCaption && this.globalCaption && c.push(this.globalCaption), this.slider[a ? "removeClass" : "addClass"]("rsVideoPlaying"), c.length)
                    for (d = 0; d < c.length; d++) a ? c[d].removeClass("rsHidden") : c[d].addClass("rsHidden")
            }
        ...
        a.fn.hashchange = function(a) {
        ...
        }, a.fn.hashchange.delay = 50, g.hashchange = a.extend(g.hashchange, {
            setup: function() {
            ...
            }, b.attachEvent && !b.addEventListener && !i && function() {
                var b, c;
                h.start = function() {
                    b || (c = (c = a.fn.hashchange.src) && c + d(), b = a('<iframe tabindex="-1" title="empty"/>').hide().one("load", function() {
                        c || l(d()), e()
    ...
    b.prototype = {
        ...
        build: function() {
            this.showCursor === !0 && (this.cursor = a('<span class="typed-cursor">' + this.cursorChar + "</span>"), this.el.after(this.cursor)), this.init()
        },
            ...
            if (this.stop !== !0) {
                ...
                d.timeout = setTimeout(function() {
                    ...
                    if ("html" === d.contentType && "<" === a.substr(b).charAt(0)) {
                        for (var g = "";
                            ">" !== a.substr(b).charAt(0);) g += a.substr(b).charAt(0), b++;
                        b++, g += ">"
                    }
                    d.timeout = setTimeout(function() {
                        if (b === a.length) {
                            ...
                            var c = d.elContent + a.substr(0, b + 1);
                            d.attr ? d.el.attr(d.attr, c) : "html" === d.contentType ? d.el.html(c) : d.el.text(c), b++, d.typewrite(a, b)
                        }
                    }, c)
                }, c)
            }
        ...
        backspace: function(a, b) {
            if (this.stop !== !0) {
                ...
                d.timeout = setTimeout(function() {
                    ...
                    var e = d.elContent + a.substr(0, b);
                    d.attr ? d.el.attr(d.attr, e) : "html" === d.contentType ? d.el.html(e) : d.el.text(e), b > d.stopNum ? (b--, d.backspace(a, b)) : b <= d.stopNum && (d.arrayPos++, d.arrayPos === d.strings.length ? (d.arrayPos = 0, d.init()) : d.typewrite(d.strings[d.arrayPos], b))
                }, c)
            }
        },
        reset: function() {
...
function(a) {
    ...
    t.prototype = {
        ...
        init: function() {
            ...
            b.isIE7 = c.indexOf("MSIE 7.") !== -1, b.isIE8 = c.indexOf("MSIE 8.") !== -1, b.isLowIE = b.isIE7 || b.isIE8, b.isAndroid = /android/gi.test(c), b.isIOS = /iphone|ipad|ipod/gi.test(c), b.supportsTransition = B(), b.probablyMobile = b.isAndroid || b.isIOS || /(Opera Mini)|Kindle|webOS|BlackBerry|(Opera Mobi)|(Windows Phone)|IEMobile/i.test(navigator.userAgent),
    ...
    a.magnificPopup.registerModule(U, {
        ...
        a.effects.animateClass = function(b, c, d, h) {
            ...
            easeInOutElastic: function(a, b, c, d, e) {
                ...
                var f = 0,
                    g = d;
                return 0 == b ? c : 2 == (b /= e / 2) ? c + d : (f || (f = .3 * e * 1.5), g < Math.abs(d) ? (g = d, a = f / 4) : a = f / (2 * Math.PI) * Math.asin(d / g), 1 > b ? -.5 * g * Math.pow(2, 10 * (b -= 1)) * Math.sin(2 * (b * e - a) * Math.PI / f) + c : g * Math.pow(2, -10 * (b -= 1)) * Math.sin(2 * (b * e - a) * Math.PI / f) * .5 + d + c)
            },
    ...
    function(a) {
        a.effects.shake = function(b) {
            return this.queue(function() {
                ...
                var k = {},
                    l = {};
                for (e[i] = ("pos" == j ? "-=" : "+=") + f, k[i] = ("pos" == j ? "+=" : "-=") + 2 * f, l[i] = ("pos" == j ? "-=" : "+=") + 2 * f, c.animate(e, h, b.options.easing), f = 1; g > f; f++) c.animate(k, h, b.options.easing).animate(l, h, b.options.easing);
    ...
    function() {
        ...
        function t(a, b, c) {
            if ("string" == typeof a) {
                if (0 === a.indexOf("#") && (a = a.slice(1)), t.Ga[a]) return t.Ga[a];
                a = t.w(a)
            }
        ...
        function G(a) {
            var b, c, d, e, g, h, i, j;
            b = 0, c = k, a.c("touchstart", function(a) {
                ...
                e = l
            }, a.c("touchleave", g), a.c("touchcancel", g), a.c("touchend", function(a) {
                c = k, e === f && (d = (new Date).getTime() - b, 250 > d && (a.preventDefault(), this.l("tap")))
            })
        }

        function H(a, b) {
            var c, d, e, f;
            return c = a.b, d = t.Hd(c), f = e = c.offsetWidth, c = a.handle, a.options().vertical ? (f = d.top, d = b.changedTouches ? b.changedTouches[0].pageY : b.pageY, c && (c = c.w().offsetHeight, f += c / 2, e -= c), Math.max(0, Math.min(1, (f - d + e) / e))) : (e = d.left, d = b.changedTouches ? b.changedTouches[0].pageX : b.pageX, c && (c = c.w().offsetWidth, e += c / 2, f -= c), Math.max(0, Math.min(1, (d - e) / f)))
        }

        function ca(a, b) {
            a.U(b), b.c("click", t.bind(a, function() {
                E(this)
            }))
        }

        function J(a) {
            a.xa = f, a.Fa.n("vjs-lock-showing"), a.b.setAttribute("aria-pressed", f), a.P && 0 < a.P.length && a.P[0].w().focus()
        }

        function I(a) {
            a.xa = l, E(a.Fa), a.b.setAttribute("aria-pressed", l)
        }
        ...
        function da(a) {
            ...
            if (b = t.Ea(a), c = b["data-setup"], c !== k && t.h.z(b, t.JSON.parse(c || "{}")), t.h.z(d, b), a.hasChildNodes()) {
                var e, f;
                for (a = a.childNodes, e = 0, f = a.length; f > e; e++) b = a[e], c = b.nodeName.toLowerCase(), "source" === c ? d.sources.push(t.Ea(b)) : "track" === c && d.tracks.push(t.Ea(b))
            }
            return d
        }

        function Q(a, b, c) {
            a.o && (a.oa = l, a.o.dispose(), a.o = l), "Html5" !== b && a.I && (t.g.Gb(a.I), a.I = k), a.La = b, a.oa = l;
            var d = t.h.z({
                source: c,
                parentEl: a.b
            }, a.m[b.toLowerCase()]);
            c && (a.xc = c.type, c.src == a.F.src && 0 < a.F.currentTime && (d.startTime = a.F.currentTime), a.F.src = c.src), a.o = new window.videojs[b](a, d), a.o.H(function() {
                this.d.Na()
            })
        }
        ...
        function U(a, b) {
            ...
            c ? c.o === a.La ? a.src(c.source) : Q(a, c.o, c.source) : (a.setTimeout(function() {
                this.error({
                    code: 4,
        ...
        function fa(a) {
            a.Rb = l, a.kb(), a.k("play", a.ad), a.k("pause", a.kb)
        }
        ...
        function Y(a, b, c) {
            for (var d, e, f = a.Ma, g = 0, h = f.length; h > g; g++) d = f[g], d.id() === b ? (d.show(), e = d) : c && d.M() == c && 0 < d.mode() && d.disable();
            (b = e ? e.M() : c ? c : l) && a.l(b + "trackchange")
        }

        function oa(a) {
            0 === a.sa && a.load(), 0 === a.qa && (a.d.c("timeupdate", t.bind(a, a.update, a.K)), a.d.c("ended", t.bind(a, a.reset, a.K)), ("captions" === a.G || "subtitles" === a.G) && a.d.na("textTrackDisplay").U(a))
        }
        ...
        t.bc = "4.11", t.ed = "https:" == document.location.protocol ? "https://" : "http://", t.options = {
        ...
        }, "GENERATED_CDN_VSN" !== t.bc && (videojs.options.flash.swf = t.ed + "vjs.zencdn.net/" + t.bc + "/video-js.swf"), t.sd = function(a, c) {
            return t.options.languages[a] = t.options.languages[a] !== b ? t.W.pa(t.options.languages[a], c) : c, t.options.languages
        }, t.Ga = {}, "function" == typeof define && define.amd ? define([], function() {
            return videojs
        }) : "object" == typeof exports && "object" == typeof module && (module.exports = videojs), t.va = t.CoreObject = m(), t.va.extend = function(a) {
            var b, c;
            a = a || {}, b = a.init || a.i || this.prototype.init || this.prototype.i || m(), c = function() {
                b.apply(this, arguments)
            }, c.prototype = t.h.create(this.prototype), c.prototype.constructor = c, c.extend = t.va.extend, c.create = t.va.create;
            ...
            var d = t.getData(a);
            d.C || (d.C = {}), d.C[b] || (d.C[b] = []), c.q || (c.q = t.q++), d.C[b].push(c), d.X || (d.disabled = l, d.X = function(b) {
                if (!d.disabled) {
                    b = t.Cc(b);
                    var c = d.C[b.type];
                    if (c)
                        for (var c = c.slice(0), e = 0, f = c.length; f > e && !b.Jc(); e++) c[e].call(a, b)
                }
            }), 1 == d.C[b].length && (a.addEventListener ? a.addEventListener(b, d.X, l) : a.attachEvent && a.attachEvent("on" + b, d.X))
        }, t.k = function(a, b, c) {
            if (t.Ec(a)) {
                var d = t.getData(a);
                if (d.C) {
                    ...
                    if (b) {
                        ...
                        if (e) {
                            if (c) {
                                if (c.q)
                                    for (d = 0; d < e.length; d++) e[d].q === c.q && e.splice(d--, 1)
                            } else d.C[b] = [];
                            t.sc(a, b)
                        }
                    } else
                        for (e in d.C) b = e, d.C[b] = [], t.sc(a, b)
                }
            }
        }, t.sc = function(a, b) {
            var c = t.getData(a);
            0 === c.C[b].length && (delete c.C[b], a.removeEventListener ? a.removeEventListener(b, c.X, l) : a.detachEvent && a.detachEvent("on" + b, c.X)), t.Ob(c.C) && (delete c.C, delete c.X, delete c.disabled), t.Ob(c) && t.Sc(a)
        }, t.Cc = function(a) {
            function b() {
                return f
            }
            ...
            if (!a || !a.Pb) {
                ...
                if (a.target || (a.target = a.srcElement || document), a.relatedTarget = a.fromElement === a.target ? a.toElement : a.fromElement, a.preventDefault = function() {
                        d.preventDefault && d.preventDefault(), a.returnValue = l, a.Nd = b, a.defaultPrevented = f
                    }, a.Nd = c, a.defaultPrevented = l, a.stopPropagation = function() {
                        d.stopPropagation && d.stopPropagation(), a.cancelBubble = f, a.Pb = b
                    }, a.Pb = c, a.stopImmediatePropagation = function() {
                        d.stopImmediatePropagation && d.stopImmediatePropagation(), a.Jc = b, a.stopPropagation()
                    }, a.Jc = c, a.clientX != k) {
            ...
            var c = t.Ec(a) ? t.getData(a) : {},
                d = a.parentNode || a.ownerDocument;
            return "string" == typeof b && (b = {
                type: b,
                target: a
            }), b = t.Cc(b), c.X && c.X.call(a, b), d && !b.Pb() && b.bubbles !== l ? t.l(d, b) : d || b.defaultPrevented || (c = t.getData(b.target), !b.target[b.type]) || (c.disabled = f, "function" == typeof b.target[b.type] && b.target[b.type](), c.disabled = l), !b.defaultPrevented
        }, t.Q = function(a, b, c) {
            function d() {
                t.k(a, b, d), c.apply(this, arguments)
            }
            return t.h.isArray(b) ? u(t.Q, a, b, c) : (d.q = c.q = c.q || t.q++, void t.c(a, b, d))
        };
        var v = Object.prototype.hasOwnProperty;
        t.e = function(a, b) {
            var c;
            return b = b || {}, c = document.createElement(a || "div"), t.h.Y(b, function(a, b) {
            ...
            var c, d, e;
            a = t.h.copy(a);
            for (c in b) v.call(b, c) && (d = a[c], e = b[c], a[c] = t.h.ab(d) && t.h.ab(e) ? t.h.Ad(d, e) : b[c]);
            return a
        }, t.h.copy = function(a) {
            return t.h.z({}, a)
        }, t.h.ab = function(a) {
            ...
            return b.q || (b.q = t.q++), d.q = c ? c + "_" + b.q : b.q, d
        }, t.ya = {}, t.q = 1, t.expando = "vdata" + (new Date).getTime(), t.getData = function(a) {
            var b = a[t.expando];
            return b || (b = a[t.expando] = t.q++, t.ya[b] = {}), t.ya[b]
        }, t.Ec = function(a) {
            return a = a[t.expando], !(!a || t.Ob(t.ya[a]))
        }, t.Sc = function(a) {
            var b = a[t.expando];
            if (b) {
                delete t.ya[b];
            ...
            t.$a(a, b) || (a.className = "" === a.className ? b : a.className + " " + b)
        }, t.r = function(a, b) {
            var c, d;
            if (t.$a(a, b)) {
        ...
        var ba = t,
            ...
            B, C;
        A ? (B = A[1] && parseFloat(A[1]), C = A[2] && parseFloat(A[2]), z = B && C ? parseFloat(A[1] + "." + A[2]) : B ? B : k) : z = k, ba.ac = z, t.od = t.hd && /webkit/i.test(t.N) && 2.3 > t.ac, t.jd = /Firefox/i.test(t.N), t.Be = /Chrome/i.test(t.N), t.wb = !!("ontouchstart" in window || window.gd && document instanceof window.gd), t.fd = "backgroundSize" in t.A.style, t.Uc = function(a, b) {
            t.h.Y(b, function(b, c) {
            ...
            var b, c, d, e;
            e = "protocol hostname port pathname search hash host".split(" "), c = t.e("a", {
                href: a
            }), (d = "" === c.host && "file:" !== c.protocol) && (b = t.e("div"), b.innerHTML = '<a href="' + a + '"></a>', c = b.firstChild, b.setAttribute("style", "display:none; position:absolute;"), document.body.appendChild(b)), a = {};
        ...
        }, t.pc = {}, t.pc.forEach = function(a, b, c) {
            if (t.h.isArray(a) && b instanceof Function)
                for (var d = 0, e = a.length; e > d; ++d) b.call(c || t, a[d], d, a);
            return a
        }, t.ye = function(a, b) {
            var c, d, e, g, h, i, j;
            "string" == typeof a && (a = {
                ...
                window.clearTimeout(h), b(k, d, d.response || d.responseText)
            }, j = function(a) {
                window.clearTimeout(h), a && "string" != typeof a || (a = Error(a)), b(a, d)
            ...
            }), d = new c, d.uri = a.uri, c = t.fe(a.uri), e = window.location, c.protocol + c.host === e.protocol + e.host || !window.XDomainRequest || "withCredentials" in d ? (g = "file:" == c.protocol || "file:" == e.protocol, d.onreadystatechange = function() {
                if (4 === d.readyState) {
            ...
            a.withCredentials && (d.withCredentials = f), a.responseType && (d.responseType = a.responseType);
            try {
                d.send()
            } catch (n) {
                j(n)
            }
        }, t.W = {}, t.W.pa = function(a, b) {
            var c, d, e;
            a = t.h.copy(a);
            for (c in b) b.hasOwnProperty(c) && (d = a[c], e = b[c], a[c] = t.h.ab(d) && t.h.ab(e) ? t.W.pa(d, e) : b[c]);
            return a
        }, t.a = t.va.extend({
            i: function(a, b, c) {
                if (this.d = a, this.m = t.h.copy(this.m), b = this.options(b), this.K = b.id || b.el && b.el.id, this.K || (this.K = (a.id && a.id() || "no_player") + "_component_" + t.q++), this.Vd = b.name || k, this.b = b.el || this.e(), this.O = [], this.Xa = {}, this.Ya = {}, this.Gc(), this.H(c), b.Tc !== l) {
                    var d, e;
                    this.j().reportUserActivity && (d = t.bind(this.j(), this.j().reportUserActivity), this.c("touchstart", function() {
                        d(), this.clearInterval(e), e = this.setInterval(d, 250)
                    }), a = function() {
                        d(), this.clearInterval(e)
        ...
        }, s.id = n("K"), s.name = n("Vd"), s.children = n("O"), s.Kd = function(a) {
            return this.Xa[a]
        }, s.na = function(a) {
            return this.Ya[a]
        }, s.U = function(a, b) {
            var c, d;
            return "string" == typeof a ? (d = a, b = b || {}, c = b.componentClass || t.ba(d), b.name = d, c = new window.videojs[c](this.d || this, b)) : c = a, this.O.push(c), "function" == typeof c.id && (this.Xa[c.id()] = c), (d = d || c.name && c.name()) && (this.Ya[d] = c), "function" == typeof c.el && c.el() && this.ma().appendChild(c.el()), c
        }, s.removeChild = function(a) {
            if ("string" == typeof a && (a = this.na(a)), a && this.O) {
                for (var b = l, c = this.O.length - 1; c >= 0; c--)
                    if (this.O[c] === a) {
                        b = f, this.O.splice(c, 1);
                        break
                    }
                b && (this.Xa[a.id()] = k, this.Ya[a.name()] = k, (b = a.w()) && b.parentNode === this.ma() && this.ma().removeChild(a.w()))
            }
        }, s.Gc = function() {
            var a, c, d, e, f, g;
            if (a = this, c = a.options(), d = c.children)
                if (g = function(d, e) {
                        c[d] !== b && (e = c[d]), e !== l && (a[d] = a.U(d, e))
                    }, t.h.isArray(d))
                    for (var h = 0; h < d.length; h++) e = d[h], "string" == typeof e ? (f = e, e = {}) : f = e.name, g(f, e);
                else t.h.Y(d, g)
        }, s.S = r(""), s.c = function(a, b, c) {
            var d, e, f;
            return "string" == typeof a || t.h.isArray(a) ? t.c(this.b, a, t.bind(this, b)) : (d = t.bind(this, c), f = this, e = function() {
                f.k(a, b, d)
            }, e.q = d.q, this.c("dispose", e), c = function() {
                f.k("dispose", e)
            }, c.q = d.q, a.nodeName ? (t.c(a, b, d), t.c(a, "dispose", c)) : "function" == typeof a.c && (a.c(b, d), a.c("dispose", c))), this
        }, s.k = function(a, b, c) {
            return !a || "string" == typeof a || t.h.isArray(a) ? t.k(this.b, a, b) : (c = t.bind(this, c), this.k("dispose", c), a.nodeName ? (t.k(a, b, c), t.k(a, "dispose", c)) : (a.k(b, c), a.k("dispose", c))), this
        }, s.Q = function(a, b, c) {
            var d, e, f;
            return "string" == typeof a || t.h.isArray(a) ? t.Q(this.b, a, t.bind(this, b)) : (d = t.bind(this, c), e = this, f = function() {
                e.k(a, b, f), d.apply(this, arguments)
            }, f.q = d.q, this.c(a, b, f)), this
        }, s.l = function(a) {
            return t.l(this.b, a), this
        }, s.H = function(a) {
            return a && (this.oa ? a.call(this) : (this.hb === b && (this.hb = []), this.hb.push(a))), this
        }, s.Na = function() {
            this.oa = f;
            var a = this.hb;
            if (a && 0 < a.length) {
            ...
            return c.q = "vjs-timeout-" + d, this.c("dispose", c), d
        }, s.clearTimeout = function(a) {
            function b() {}
            return clearTimeout(a), b.q = "vjs-timeout-" + a, this.k("dispose", b), a
            ...
            return c.q = "vjs-interval-" + d, this.c("dispose", c), d
        }, s.clearInterval = function(a) {
            function b() {}
            return clearInterval(a), b.q = "vjs-interval-" + a, this.k("dispose", b), a
        }, t.u = t.a.extend({
            i: function(a, b) {
                t.a.call(this, a, b), G(this), this.c("tap", this.s), this.c("click", this.s), this.c("focus", this.fb), this.c("blur", this.eb)
            }
        }), s = t.u.prototype, s.e = function(a, b) {
            var c;
            return b = t.h.z({
                className: this.S(),
                role: "button",
                "aria-live": "polite",
                tabIndex: 0
            }, b), c = t.a.prototype.e.call(this, a, b), b.innerHTML || (this.v = t.e("div", {
                className: "vjs-control-content"
            }), this.Cb = t.e("span", {
                className: "vjs-control-text",
                innerHTML: this.t(this.la) || "Need Text"
            }), this.v.appendChild(this.Cb), c.appendChild(this.v)), c
        }, s.S = function() {
            return "vjs-control " + t.a.prototype.S.call(this)
        }, s.s = m(), s.fb = function() {
            t.c(document, "keydown", t.bind(this, this.ea))
        }, s.ea = function(a) {
            (32 == a.which || 13 == a.which) && (a.preventDefault(), this.s())
        }, s.eb = function() {
            t.k(document, "keydown", t.bind(this, this.ea))
        }, t.R = t.a.extend({
            i: function(a, b) {
                t.a.call(this, a, b), this.td = this.na(this.m.barName), this.handle = this.na(this.m.handleName), this.c("mousedown", this.gb), this.c("touchstart", this.gb), this.c("focus", this.fb), this.c("blur", this.eb), this.c("click", this.s), this.c(a, "controlsvisible", this.update), this.c(a, this.Oc, this.update)
            }
        }), s = t.R.prototype, s.e = function(a, b) {
            return b = b || {}, b.className += " vjs-slider", b = t.h.z({
                role: "slider",
                "aria-valuenow": 0,
                "aria-valuemin": 0,
                "aria-valuemax": 100,
            ...
            a.preventDefault(), t.ud(), this.n("vjs-sliding"), this.c(document, "mousemove", this.fa), this.c(document, "mouseup", this.ra), this.c(document, "touchmove", this.fa), this.c(document, "touchend", this.ra), this.fa(a)
            ...
            37 == a.which || 40 == a.which ? (a.preventDefault(), this.Yc()) : (38 == a.which || 39 == a.which) && (a.preventDefault(), this.Zc())
        }, s.eb = function() {
            this.k(document, "keydown", this.ea)
        }, s.s = function(a) {
            a.stopImmediatePropagation(), a.preventDefault()
        }, t.$ = t.a.extend(), t.$.prototype.defaultValue = 0, t.$.prototype.e = function(a, b) {
            return b = b || {}, b.className += " vjs-slider-handle", b = t.h.z({
                innerHTML: '<span class="vjs-control-text">' + this.defaultValue + "</span>"
            }, b), t.a.prototype.e.call(this, "div", b)
            ...
            return this.v = t.e(a, {
                ...
                append: this.v,
                className: "vjs-menu"
            }), a.appendChild(this.v), t.c(a, "click", function(a) {
                a.preventDefault(), a.stopImmediatePropagation()
            }), a
        }, t.J = t.u.extend({
            i: function(a, b) {
                t.u.call(this, a, b), this.selected(b.selected)
            }
            ...
            i: function(a, b) {
                t.u.call(this, a, b), this.Fa = this.Aa(), this.U(this.Fa), this.P && 0 === this.P.length && this.Z(), this.c("keydown", this.ea), this.b.setAttribute("aria-haspopup", f), this.b.setAttribute("role", "button")
            }
            ...
            if (this.options().title && a.ma().appendChild(t.e("li", {
                ...
                for (var b = 0; b < this.P.length; b++) ca(a, this.P[b]);
            return a
        }, s.za = m(), s.S = function() {
            ...
            "number" == typeof a ? this.code = a : "string" == typeof a ? this.message = a : "object" == typeof a && t.h.z(this, a), this.message || (this.message = t.D.Bd[this.code] || "")
        ...
        t.Player = t.a.extend({
            i: function(a, b, c) {
                this.I = a, a.id = a.id || "vjs_video_" + t.q++, this.se = a && t.Ea(a), b = t.h.z(da(a), b), this.bb = b.language || t.options.language, this.Td = b.languages || t.options.languages, this.F = {}, this.Pc = b.poster || "", this.Db = !!b.controls, a.controls = l, b.Tc = l, P(this, "audio" === this.I.nodeName.toLowerCase()), t.a.call(this, this, b, c), this.n(this.controls() ? "vjs-controls-enabled" : "vjs-controls-disabled"), P(this) && this.n("vjs-audio"), t.Ga[this.K] = this, b.plugins && t.h.Y(b.plugins, function(a, b) {
                    this[a](b)
                }, this);
                var d, e, g, h, i;
                d = t.bind(this, this.reportUserActivity), this.c("mousedown", function() {
                    d(), this.clearInterval(e), e = this.setInterval(d, 250)
                }), this.c("mousemove", function(a) {
                    (a.screenX != h || a.screenY != i) && (h = a.screenX, i = a.screenY, d())
                }), this.c("mouseup", function() {
                    d(), this.clearInterval(e)
                }), this.c("keydown", d), this.c("keyup", d), this.setInterval(function() {
                    if (this.ua) {
                        this.ua = l, this.userActive(f), this.clearTimeout(g);
            ...
            return a === b ? this.bb : (this.bb = a, this)
            ...
            return a = t.Ea(c), t.h.Y(a, function(c) {
            ...
            return a !== b ? (this.F.duration = parseFloat(a), this) : (this.F.duration === b && this.Mc(), this.F.duration || 0)
        }, s.remainingTime = function() {
            return this.duration() - this.currentTime()
        }, s.buffered = function() {
            var a = S(this, "buffered");
            return a && a.length || (a = t.Eb(0, 0)), a
        ...
        }, s.Ic = l, s.isFullscreen = function(a) {
            ...
            var a = t.Va.Kb;
            return this.isFullscreen(f), a ? (t.c(document, a.fullscreenchange, t.bind(this, function(b) {
                this.isFullscreen(document[a.fullscreenElement]), this.isFullscreen() === l && t.k(document, a.fullscreenchange, arguments.callee), this.l("fullscreenchange")
            })), this.b[a.requestFullscreen]()) : this.o.Ka() ? T(this, "enterFullScreen") : (this.Bc(), this.l("fullscreenchange")), this
        }, s.requestFullScreen = function() {
            ...
            var a = t.Va.Kb;
            return this.isFullscreen(l), a ? document[a.exitFullscreen]() : this.o.Ka() ? T(this, "exitFullScreen") : (this.Hb(), this.l("fullscreenchange")), this
            ...
            for (var b = 0, c = this.m.techOrder; b < c.length; b++) {
                var d = t.ba(c[b]),
                    e = window.videojs[d];
                if (e) {
                    if (e.isSupported())
            ...
            return a === b ? S(this, "src") : (t.h.isArray(a) ? U(this, a) : "string" == typeof a ? this.src({
                ...
                window.videojs[this.La].prototype.hasOwnProperty("setSource") ? T(this, "setSource", a) : T(this, "src", a.src), "auto" == this.m.preload && this.load(), this.m.autoplay && this.play()
            }))), this)
        }, s.load = function() {
            ...
            return a === b ? this.Pc : (a || (a = ""), this.Pc = a, T(this, "setPoster", a), this.l("posterchange"), this)
        ...
        }, t.Player.prototype.Zb, s = t.Player.prototype, s.usingNativeControls = function(a) {
            ...
            return a === b ? this.da : a === k ? (this.da = a, this.r("vjs-error"), this) : (this.da = a instanceof t.D ? a : new t.D(a), this.l("error"), this.n("vjs-error"), t.log.error("(CODE:" + this.da.code + " " + t.D.Za[this.da.code] + ")", this.da.message, this.da), this)
        }, s.ended = function() {
            return S(this, "ended")
        }, s.seeking = function() {
            ...
            this.ua = f
        }, s.Yb = f, s.userActive = function(a) {
            return a !== b ? (a = !!a, a !== this.Yb && ((this.Yb = a) ? (this.ua = f,
                this.r("vjs-user-inactive"), this.n("vjs-user-active"), this.l("useractive")) : (this.ua = l, this.o && this.o.Q("mousemove", function(a) {
            ...
            i: function(a, b) {
                t.u.call(this, a, b), this.c(a, "play", this.Tb), this.c(a, "pause", this.Sb)
            }
            ...
            i: function(a, b) {
                t.a.call(this, a, b), this.c(a, "timeupdate", this.ia)
            }
            ...
            i: function(a, b) {
                t.R.call(this, a, b), this.c(a, "timeupdate", this.ta), a.H(t.bind(this, this.ta))
            }
            ...
            var a = this.d.ib ? this.d.F.currentTime : this.d.currentTime();
            this.b.setAttribute("aria-valuenow", t.round(100 * this.Lb(), 2)), this.b.setAttribute("aria-valuetext", t.Da(a, this.d.duration()))
        }, s.Lb = function() {
            return this.d.currentTime() / this.d.duration()
        }, s.gb = function(a) {
            t.R.prototype.gb.call(this, a), this.d.ib = f, this.xe = !this.d.paused(), this.d.pause()
        }, s.fa = function(a) {
            a = H(this, a) * this.d.duration(), a == this.d.duration() && (a -= .1), this.d.currentTime(a)
        }, s.ra = function(a) {
            t.R.prototype.ra.call(this, a), this.d.ib = l, this.xe && this.d.play()
        }, s.Zc = function() {
            ...
            i: function(a, b) {
                t.a.call(this, a, b), this.c(a, "progress", this.update)
            }
            ...
            i: function(a, b) {
                t.$.call(this, a, b), this.c(a, "timeupdate", this.ia)
            }
            ...
            i: function(a, b) {
                t.a.call(this, a, b), a.o && a.o.featuresVolumeControl === l && this.n("vjs-hidden"), this.c(a, "loadstart", function() {
            ...
            i: function(a, b) {
                t.R.call(this, a, b), this.c(a, "volumechange", this.ta), a.H(t.bind(this, this.ta))
            }
            ...
            this.d.muted() && this.d.muted(l), this.d.volume(H(this, a))
        }, s.Lb = function() {
            ...
            i: function(a, b) {
                t.u.call(this, a, b), this.c(a, "volumechange", this.update), a.o && a.o.featuresVolumeControl === l && this.n("vjs-hidden"), this.c(a, "loadstart", function() {
                    a.o.featuresVolumeControl === l ? this.n("vjs-hidden") : this.r("vjs-hidden")
                })
            }
            ...
            i: function(a, b) {
                t.L.call(this, a, b), this.c(a, "volumechange", this.update), a.o && a.o.featuresVolumeControl === l && this.n("vjs-hidden"), this.c(a, "loadstart", function() {
                    a.o.featuresVolumeControl === l ? this.n("vjs-hidden") : this.r("vjs-hidden")
            ...
            var a = new t.ja(this.d, {
                ...
                b = new t.xb(this.d, this.m.volumeBar);
            return b.c("focus", function() {
            ...
            i: function(a, b) {
                t.L.call(this, a, b), this.cd(), this.bd(), this.c(a, "loadstart", this.cd), this.c(a, "ratechange", this.bd)
            }
            ...
            return this.Kc = t.e("div", {
                ...
                innerHTML: 1
            }), a.appendChild(this.Kc), a
        }, s.Aa = function() {
            var a = new t.ja(this.j()),
                b = this.j().options().playbackRates;
            if (b)
                for (var c = b.length - 1; c >= 0; c--) a.U(new t.tb(this.j(), {
                    rate: b[c] + "x"
                }));
            return a
        }, s.ta = function() {
            ...
            for (var a = this.j().playbackRate(), b = this.j().options().playbackRates, c = b[0], d = 0; d < b.length; d++)
                if (b[d] > a) {
                    c = b[d];
                    break
                }
            ...
            i: function(a, b) {
                var c = this.label = b.rate,
                    d = this.Rc = parseFloat(c, 10);
                b.label = c, b.selected = 1 === d, t.J.call(this, a, b), this.c(a, "ratechange", this.update)
            }
            ...
            i: function(a, b) {
                t.u.call(this, a, b), this.update(), a.c("posterchange", t.bind(this, this.update))
            }
            ...
            return t.fd || (this.Ib = t.e("img"), a.appendChild(this.Ib)), a
        }, s.update = function() {
            var a = this.j().poster();
            this.ga(a), a ? this.b.style.display = "" : this.Z()
        }, s.ga = function(a) {
            var b;
            this.Ib ? this.Ib.src = a : (b = "", a && (b = 'url("' + a + '")'), this.b.style.backgroundImage = b)
        }, s.s = function() {
            this.d.play()
        }, t.fc = t.a.extend({
            i: function(a, b) {
            ...
            i: function(a, b) {
                t.a.call(this, a, b), this.update(), this.c(a, "error", this.update)
            }
            ...
            i: function(a, b, c) {
                b = b || {}, b.Tc = l, t.a.call(this, a, b, c), this.featuresProgressEvents || (this.Lc = f, this.Qc = this.setInterval(function() {
                    var a = this.j().bufferedPercent();
                    this.vd != a && this.j().l("progress"), this.vd = a, 1 === a && this.clearInterval(this.Qc)
                }, 500)), this.featuresTimeupdateEvents || (a = this.d, this.Rb = f, this.c(a, "play", this.ad), this.c(a, "pause", this.kb), this.Q("timeupdate", function() {
                ...
                }, this.H(a), this.c(d, "controlsenabled", a), this.c(d, "controlsdisabled", this.he), this.H(function() {
        ...
        }, s.Vc = m(), t.p.prototype.featuresVolumeControl = f, t.p.prototype.featuresFullscreenResize = l, t.p.prototype.featuresPlaybackRate = l, t.p.prototype.featuresProgressEvents = l, t.p.prototype.featuresTimeupdateEvents = l, t.p.$b = function(a) {
            a.Ia = function(c, d) {
                var e = a.Wc;
                e || (e = a.Wc = []), d === b && (d = e.length), e.splice(d, 0, c)
            }, a.jb = function(b) {
                for (var c, d = a.Wc || [], e = 0; e < d.length; e++)
                    if (c = d[e].Wa(b)) return d[e];
                return k
            }, a.rc = function(b) {
                var c = a.jb(b);
                return c ? c.Wa(b) : ""
                ...
                var c = a.jb(b);
                return this.Ba(), this.k("dispose", this.Ba), this.vc = b, this.Xb = c.Mb(b, this), this.c("dispose", this.Ba), this
            }, a.prototype.Ba = function() {
                this.Xb && this.Xb.dispose && this.Xb.dispose()
            }
        }, t.g = t.p.extend({
            i: function(a, b, c) {
                for (t.p.call(this, a, b, c), c = t.g.qb.length - 1; c >= 0; c--) this.c(t.g.qb[c], this.Fd);
                if ((b = b.source) && (this.b.currentSrc !== b.src || a.I && 3 === a.I.Md) && this.Ja(b), t.wb && a.options().nativeControlsForTouch === f) {
                    var d, e, g, h;
                    d = this, e = this.j(), b = e.controls(), d.b.controls = !!b, g = function() {
                        d.b.controls = f
                    }, h = function() {
                        d.b.controls = l
                    }, e.c("controlsenabled", g), e.c("controlsdisabled", h), b = function() {
                        e.k("controlsenabled", g), e.k("controlsdisabled", h)
                    }, d.c("dispose", b), e.c("usingcustomcontrols", b), e.usingNativeControls(f)
                }
                a.H(function() {
            ...
            var a, b = this.d,
                c = b.I;
            c && this.movingMediaElementInDOM !== l || (c ? (a = c.cloneNode(l), t.g.Gb(c), c = a, b.I = k) : (c = t.e("video"), a = videojs.W.pa({}, b.se), (!t.wb || b.options().nativeControlsForTouch !== f) && delete a.controls, t.Uc(c, t.h.z(a, {
                id: b.id() + "_html5_api",
                "class": "vjs-tech"
            }))), c.player = b, t.Nb(c, b.w())), a = ["autoplay", "preload", "loop", "muted"];
            for (var d = a.length - 1; d >= 0; d--) {
                var e = a[d],
                    g = {};
                "undefined" != typeof b.m[e] && (g[e] = b.m[e]), t.Uc(c, g)
            }
            return c
        }, s.Fd = function(a) {
        ...
        }, t.p.$b(t.g), t.g.V = {}, t.g.V.Wa = function(a) {
            function b(a) {
                try {
            ...
            return a.type ? b(a.type) : a.src ? (a = (a = a.src.match(/\.([^.\/\?]+)(\?[^\/]+)?$/i)) && a[1], b("video/" + a)) : ""
        }, t.g.V.Mb = function(a, b) {
            b.ga(a.src)
        ...
        t.g.Nc = function() {
            ...
            return t.A.constructor.prototype.canPlayType = V, V = k, a
        }, t.g.Nc(), t.g.qb = "loadstart suspend abort error emptied stalled loadedmetadata loadeddata canplay canplaythrough playing waiting seeking seeked ended durationchange timeupdate progress play pause ratechange volumechange".split(" "), t.g.Gb = function(a) {
            if (a) {
            ...
            i: function(a, b, c) {
                ...
                d && this.H(function() {
                    this.Ja(d)
                }), t.Nb(e, c), b.startTime && this.H(function() {
                ...
                }), a.c("stageclick", a.reportUserActivity), this.b = t.f.zc(b.swf, e, g, h, f)
            }
            ...
            this.Ud = a, this.b.vjs_setProperty("currentTime", a), t.p.prototype.Wb.call(this)
        ...
        if (t.f.isSupported = function() {
            ...
            }, t.p.$b(t.f), t.f.V = {}, t.f.V.Wa = function(a) {
                return a.type && a.type.replace(/;.*/, "").toLowerCase() in t.f.Id ? "maybe" : ""
            }, t.f.V.Mb = function(a, b) {
                b.ga(a.src)
                ...
                var b;
                (b = (a = t.w(a)) && a.parentNode && a.parentNode.player) && (a.player = b, t.f.checkReady(b.o))
                ...
                return a.split(",")
            }, t.f.zc = function(a, b, c, d, e) {
                a = t.f.Ld(a, c, d, e), a = t.e("div", {
                    innerHTML: a
                ...
                return b && t.h.Y(b, function(a, b) {
                    ...
                    allowNetworking: "all"
                }, c), t.h.Y(c, function(a, b) {
                    f += '<param name="' + a + '" value="' + b + '" />'
                }), d = t.h.z({
                    data: a,
                    width: "100%",
                    height: "100%"
                }, d), t.h.Y(d, function(a, b) {
                    g += a + '="' + b + '" '
                ...
                if (!a) return b;
                var c, d = a.indexOf("&");
                return -1 !== d ? c = d + 1 : (d = c = a.lastIndexOf("/") + 1, 0 === d && (d = c = a.length)), b.tc = a.substring(0, d), b.$c = a.substring(c, a.length), b
            }, t.f.Rd = function(a) {
                return a in t.f.qe
            }, t.f.qd = /^rtmp[set]?:\/\//i, t.f.Qd = function(a) {
                return t.f.qd.test(a)
            }, t.f.Vb = {}, t.f.Vb.Wa = function(a) {
                return t.f.Rd(a.type) || t.f.Qd(a.src) ? "maybe" : ""
            }, t.f.Vb.Mb = function(a, b) {
                var c = t.f.pe(a.src);
                b.setRtmpConnection(c.tc), b.setRtmpStream(c.$c)
            }, t.f.Ia(t.f.Vb), t.pd = t.a.extend({
                i: function(a, b, c) {
                    if (t.a.call(this, a, b, c), a.m.sources && 0 !== a.m.sources.length) a.src(a.m.sources);
                    else
                        for (b = 0, c = a.m.techOrder; b < c.length; b++) {
                            var d = t.ba(c[b]),
                                e = window.videojs[d];
                            if (e && e.isSupported()) {
                                Q(a, d);
                ...
                i: function(a, b) {
                    t.a.call(this, a, b), this.K = b.id || "vjs_" + b.kind + "_" + b.language + "_" + t.q++, this.Xc = b.src, this.Cd = b["default"] || b.dflt, this.ue = b.title, this.bb = b.srclang, this.Sd = b.label, this.ca = [], this.Ab = [], this.qa = this.sa = 0, a.c("dispose", t.bind(this, this.yc, this.K))
                }
                ...
                0 === this.sa && (this.sa = 1, t.ye(this.Xc, t.bind(this, function(a, b, c) {
                        ...
                        for (var f = a.length; f > c; c++)
                            if (b = t.trim(a[c])) {
                                for (-1 == b.indexOf("-->") ? (d = b, b = t.trim(a[++c])) : d = this.ca.length, d = {
                                    ...
                                    }, e = b.split(/[\t ]+/), d.startTime = pa(e[0]), d.Ca = pa(e[2]), e = []; a[++c] && (b = t.trim(a[c]));) e.push(b);
                                d.text = e.join("<br/>"), this.ca.push(d)
                            }
                ...
                if (0 < this.ca.length) {
                    ...
                    if (this.Ub === b || a < this.Ub || this.cb <= a) {
                        var c, d, e, g, h = this.ca,
                            ...
                            k = l,
                            m = [];
                        for (a >= this.cb || this.cb === b ? g = this.Jb !== b ? this.Jb : 0 : (k = f, g = this.Qb !== b ? this.Qb : h.length - 1);;) {
                            if (e = h[g], e.Ca <= a) j = Math.max(j, e.Ca), e.Ua && (e.Ua = l);
                            else if (a < e.startTime) {
                                if (i = Math.min(i, e.startTime), e.Ua && (e.Ua = l), !k) break
                            } else k ? (m.splice(0, 0, e), d === b && (d = g), c = g) : (m.push(e), c === b && (c = g), d = g), i = Math.min(i, e.Ca), j = Math.max(j, e.startTime), e.Ua = f;
                            if (k) {
                                if (0 === g) break;
                                g--
                            } else {
                        ...
                        for (this.Ab = m, this.cb = i, this.Ub = j, this.Jb = c, this.Qb = d, c = this.Ab, d = "", a = 0, h = c.length; h > a; a++) d += '<span class="vjs-tt-cue">' + c[a].text + "</span>";
                        this.b.innerHTML = d, this.l("cuechange")
                    }
                }
            }, s.reset = function() {
                ...
                i: function(a, b, c) {
                    if (t.a.call(this, a, b, c), a.m.tracks && 0 < a.m.tracks.length) {
                        b = this.d, a = a.m.tracks;
                        for (var d = 0; d < a.length; d++) c = a[d], na(b, c.kind, c.label, c.language, c)
                    }
                }
                ...
                i: function(a, b) {
                    ...
                    b.label = c.label(), b.selected = c.Fb(), t.J.call(this, a, b), this.c(a, c.M() + "trackchange", this.update)
                }
                ...
                for (var a, b = this.d.textTracks(), c = 0, d = b.length, e = f; d > c; c++) a = b[c], a.M() == this.ha.M() && 2 == a.mode() && (e = l);
                this.selected(e)
            }, t.T = t.L.extend({
                i: function(a, b) {
                    t.L.call(this, a, b), 1 >= this.P.length && this.Z()
                }
            }), t.T.prototype.za = function() {
                var a, b = [];
                b.push(new t.sb(this.d, {
                    kind: this.G
                }));
                for (var c = 0; c < this.d.textTracks().length; c++) a = this.d.textTracks()[c], a.M() === this.G && b.push(new t.aa(this.d, {
                    track: a
                }));
                return b
            }, t.Oa = t.T.extend({
                i: function(a, b, c) {
                    t.T.call(this, a, b, c), this.b.setAttribute("aria-label", "Captions Menu")
                }
            }), t.Oa.prototype.G = "captions", t.Oa.prototype.la = "Captions", t.Oa.prototype.className = "vjs-captions-button", t.Ta = t.T.extend({
                i: function(a, b, c) {
                    t.T.call(this, a, b, c), this.b.setAttribute("aria-label", "Subtitles Menu")
                }
            }), t.Ta.prototype.G = "subtitles", t.Ta.prototype.la = "Subtitles", t.Ta.prototype.className = "vjs-subtitles-button", t.Pa = t.T.extend({
                i: function(a, b, c) {
                    t.T.call(this, a, b, c), this.b.setAttribute("aria-label", "Chapters Menu")
                }
            }), s = t.Pa.prototype, s.G = "chapters", s.la = "Chapters", s.className = "vjs-chapters-button", s.za = function() {
                for (var a, b = [], c = 0; c < this.d.textTracks().length; c++) a = this.d.textTracks()[c], a.M() === this.G && b.push(new t.aa(this.d, {
                    track: a
                }));
                return b
            }, s.Aa = function() {
                for (var a, c, d = this.d.textTracks(), e = 0, f = d.length, g = this.P = []; f > e; e++)
                    if (a = d[e], a.M() == this.G) {
                        if (0 !== a.readyState()) {
                            c = a;
                            break
                        }
                        a.load(), a.c("loaded", t.bind(this, this.Aa))
                    }
                if (d = this.Fa, d === b && (d = new t.ja(this.d), d.ma().appendChild(t.e("li", {
                        className: "vjs-menu-title",
                        innerHTML: t.ba(this.G),
                        re: -1
                    }))), c) {
                    a = c.ca;
                    for (var h, e = 0, f = a.length; f > e; e++) h = a[e], h = new t.mb(this.d, {
                        track: c,
                        cue: h
                    }), g.push(h), d.U(h);
                    this.U(d)
                }
                return 0 < this.P.length && this.show(), d
            }, t.mb = t.J.extend({
                i: function(a, b) {
                    var c = this.ha = b.track,
                        d = this.cue = b.cue,
                        e = a.currentTime();
                    b.label = d.text, b.selected = d.startTime <= e && e < d.Ca, t.J.call(this, a, b), c.c("cuechange", t.bind(this, this.update))
                }
                ...
                this.selected(a.startTime <= b && b < a.Ca)
        ...
        t.qc = function() {
            ...
            var f = [];
            if (a && 0 < a.length)
                for (d = 0, e = a.length; e > d; d++) f.push(a[d]);
            if (c && 0 < c.length)
                for (d = 0, e = c.length; e > d; d++) f.push(c[d]);
            if (f && 0 < f.length)
        ...
        function b(a) {
            for (var b = 0, c = arguments.length; c > b; b++) {
                ...
                e.scrollTop(1);
                var f = e.scrollTop() > 0;
                if (e.scrollTop(0), f) return d
            }
            return []
        }

        function c() {
            k = new Array, l = new Array;
            var a;
            for (a = 0; 26 > a; a++) k[k.length] = String.fromCharCode(65 + a);
            for (a = 0; 26 > a; a++) k[k.length] = String.fromCharCode(97 + a);
            for (a = 0; 10 > a; a++) k[k.length] = String.fromCharCode(48 + a);
            for (k[k.length] = "+", k[k.length] = "/", a = 0; 128 > a; a++) l[l.length] = -1;
            for (a = 0; 64 > a; a++) l[k[a].charCodeAt(0)] = a
        }
        ...
        function d(a) {
            var b = 0,
                ...
                i = "",
                j = 0;
            do e = h[j++].charCodeAt(0), f = l[e], e >= 0 && 128 > e && f != -1 && (g % 4 == 0 ? b = f << 2 : g % 4 == 1 ? (b |= f >> 4, c = (15 & f) << 4) : g % 4 == 2 ? (c |= f >> 2, d = (3 & f) << 6) : d |= f, g++, g % 4 == 0 && (i += String.fromCharCode(b) + String.fromCharCode(c) + String.fromCharCode(d))); while ("undefined" != typeof h[j]);
            return i += g % 4 == 3 ? String.fromCharCode(b) + String.fromCharCode(c) : g % 4 == 2 ? String.fromCharCode(b) : ""
        }
        try {
            $(".rss-subscribe-button").on("click", function() {
                ga("send", "event", "button", "click", "rss-subscribe-button")
            })
        } catch (e) {}
        var f = $(".page-nav .main-nav > ul"),
            g = $(".page-menu");
        g.click(function() {
            f.slideToggle(200)
        }), $(window).resize(function() {
            g.is(":hidden") && f.is(":hidden") && f.removeAttr("style")
        });
        try {
            videojs("script-feature-video").ready(function() {
                var a = this;
                a.on("pause", function() {
                    a.bigPlayButton.show()
                }), a.on("play", function() {
                    a.bigPlayButton.hide()
                })
            })
        } catch (e) {}
        var h = $(".danEmailLink");
        for (i = 0; i < h.length; i++) $(h[i]).replaceWith('<a href="mai' + "lto:" + "dan" + "@" + "danrodney" + ".com?subject=" + $(h[i]).attr("data-emailsubject") + '">' + "dan" + "@" + "danrodney.com" + "</a>");
        var j = $(".danEmailButton");
        for (i = 0; i < j.length; i++) $(j[i]).replaceWith('<a href="mai' + "lto:" + "dan" + "@" + "danrodney" + ".com?subject=" + $(j[i]).attr("data-emailsubject") + '" class="button-call-to-action outline-on-light">' + "dan" + "@" + "danrodney.com" + "</a>");
        $(".indesign-script-reviews .royalSlider").royalSlider({
            autoHeight: !0,
            arrowsNav: !0,
            arrowsNavAutoHide: !1,
            controlsInside: !1,
            ...
            loopRewind: !0
        }), $("#mac-section-nav nav").affix({
            offset: {
                top: function() {
                    return this.top = $(".page-header").outerHeight(!0) + $(".subnav").outerHeight(!0) - 20
                },
                bottom: function() {
                    return this.bottom = $(".page-footer").outerHeight(!0) + $(".call-to-action-banner").outerHeight(!0)
                }
            }
        }), $("body").scrollspy({
            target: "#mac-section-nav"
        }), $(".homepage .occupation span").typed({
            strings: [" trainer", " web developer", " designer", "n InDesign scripter", " curriculum developer", "n all around nice guy"],
            startDelay: 500,
            typeSpeed: 40,
            backSpeed: 0,
            backDelay: 2200,
            ...
            $(".homepage .occupation").typed("reset")
        });
        a(location.pathname), b("html", "body");
        ...
        }), $(".indesign-script-feature-visual").magnificPopup({
            delegate: "a",
            type: "image",
            closeOnContentClick: !1,
            closeBtnInside: !1,
        ...
        }), $(".popup-with-zoom-anim-video").magnificPopup({
            type: "iframe",
            disableOn: 700,
            overflowY: "auto",
            closeBtnInside: !0,
        ...
        }), $(document).on("click", "#client-list-training-popup-close", function(a) {
            a.preventDefault(), $.magnificPopup.close(), location.href = "#client-list-button"
        });
        var k, l;
        $("#upgrade-code-mbj-form").submit(function() {
            if (c(), $("#upgrade-code-input").val() == d("Z2ltbWUtbWJqNg==")) {
                $(".ajax-loading").attr("src", "/img/ajax-loading.gif");
                var a = $.ajax({
                    url: "/inc/makebookjacket-up.html"
                });
                a.success(function(a) {
                    $("#upgrade-add-to-cart").html(a), $("#upgrade-code").slideUp(300)
                }), a.error(function() {
                    alert("Sorry but there was an error: " + a.status + " " + a.statusText + "\nPlease try again."), $(".ajax-loading").attr("src", "/img/spacer.gif")
                })
            } else $("#upgrade-code-mbj-form").effect("shake", {
                times: 3
            }, 80, function() {
